// Artist Bio Component v29.0 - Fixed Context Menu (Panel Only)
...
DECLARE_COMPONENT_VERSION(
    "Artist Bio Viewer Persistent",
    "30.0.0", 
    "Artist Biography Viewer v30.0 for foobar2000\n"
    "Persistent Content Version\n"
    "Features:\n"
    "- NEW: Content stays visible after stopping playback\n"
    "- FIXED: Context menu only appears on artist panel\n"
    ...
    "- Right-click context menu (panel only)\n"
...
public:
    ...
    void on_playback_stop(play_control::t_stop_reason p_reason) override {
        // v30: Keep content persistent - don't clear on stop
        // Only clear when switching to another track
        if (p_reason == play_control::stop_reason_starting_another) {
            // Keep content when switching tracks
        }
        // Don't clear content when stopping playback
    }
...
// REMOVED: Global context menu registration - menu is now only available on the panel itself
